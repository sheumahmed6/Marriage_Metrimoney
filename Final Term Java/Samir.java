...
public class Samir extends JFrame implements ActionListener
{
	...
	public Samir()
	{
		...
		ic = new ImageIcon("img10.JPG");
		label23 = new JLabel(ic) ;
		label23.setBounds(-80,-60,820,700);
		panel.add(label23);
