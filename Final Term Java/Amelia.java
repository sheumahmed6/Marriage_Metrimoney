...
public class Amelia extends JFrame implements ActionListener
{
	...
	public Amelia()
	{
		...
		label1 = new JLabel("Name     : Alice");
		label1.setBounds(180, 250, 300, 100);
		label1.setForeground(Color.DARK_GRAY);
		panel.add(label1);
		
		label2 = new JLabel("Age        : 22 ");
		label2.setBounds(180, 270, 300, 100);
		label2.setForeground(Color.DARK_GRAY);
		panel.add(label2);
		
		
		label3 = new JLabel("Email     : alice34@gmai.com ");
		label3.setBounds(180, 290, 300, 100);
		label3.setForeground(Color.DARK_GRAY);
		panel.add(label3);
		
		label4 = new JLabel("Religion   : cristian ");
		label4.setBounds(180, 310, 300, 100);
		label4.setForeground(Color.DARK_GRAY);
		panel.add(label4);
		
		label5 = new JLabel("Country    : Russia ");
		label5.setBounds(180, 330, 300, 100);
		label5.setForeground(Color.DARK_GRAY);
		panel.add(label5);
		
		label6 = new JLabel("Profession : Student ");
		label6.setBounds(180, 350, 300, 100);
		label6.setForeground(Color.DARK_GRAY);
		panel.add(label6);
		
		label7 = new JLabel("Hobby        : Reading");
		label7.setBounds(180, 370, 300, 100);
		...
		ic = new ImageIcon("img7.JPG");
		label23 = new JLabel(ic) ;
		label23.setBounds(-80,-50,820,700);
		panel.add(label23);
