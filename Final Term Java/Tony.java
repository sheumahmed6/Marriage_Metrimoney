...
public class Tony extends JFrame implements ActionListener
{
	...
	public Tony()
	{
		...
		label1 = new JLabel("Name     : Tony Kroos");
		label1.setBounds(200, 200, 300, 100);
		label1.setForeground(Color.DARK_GRAY);
		panel.add(label1);
		
		label2 = new JLabel("Age        : 29 ");
		label2.setBounds(200, 230, 300, 100);
		label2.setForeground(Color.DARK_GRAY);
		panel.add(label2);
		
		
		label3 = new JLabel("Email     : tony08@gmai.com ");
		...
		ic = new ImageIcon("img9.JPG");
		label23 = new JLabel(ic) ;
		label23.setBounds(-80,-40,820,700);
		panel.add(label23);
